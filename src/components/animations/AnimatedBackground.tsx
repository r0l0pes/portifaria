...
/**
 * Renders floating particles and gradient orbs that react to mouse movement.
 * Respects prefers-reduced-motion via framer-motion's useReducedMotion.
 * @returns {React.ReactElement | null} Background layer or null before dimensions are known
 */
